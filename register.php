        ...
        if(isset($_POST['submit'])){
            ...
            if($password != $cpassword){
                ...
                if($result->num_rows > 0){
                    $alert = 'true';
                    $errors = 'Email Already Exists Please <a href="./index.php">Login</a>!';
                }
                else {

                    $hashed_pass = password_hash($password, PASSWORD_DEFAULT);

                    $sql = "INSERT INTO `user` (`username`, `email`, `password`) VALUES ('$name', '$email', '$hashed_pass');";
                    $result = $conn->query($sql);
                    // $result == 1, $result == true, $result == 'true
                    if($result){
                        $success = 'true';
                        $successMsg = 'Your Data Has been successfully saved you can now <a href="./index.php">Login</a>!';
                    }
                }
            }
        }
